...
const GITHUB_RELEASES_URL = "https://github.com/Digital-Extensions/corpus-review-releases/releases";
            ...
            <div className="grid md:grid-cols-2 gap-6 max-w-2xl mx-auto">
              ...
              <div className="border border-border rounded-lg p-6 bg-card">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <h2 className="font-semibold text-foreground">{downloads.mac.name}</h2>
              ...
              <div className="border border-border rounded-lg p-6 bg-card">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <h2 className="font-semibold text-foreground">{downloads.windows.name}</h2>
                    <p className="text-sm text-muted-foreground">{downloads.windows.requirements}</p>
                  </div>
                </div>
                <Button
                  variant="subtle"
