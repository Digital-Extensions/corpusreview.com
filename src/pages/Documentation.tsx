...
New documents integrated, filter shows mixed results, note updated`
  ...
  "linked-assertions": {
    narration: `OPENING
"This short video shows how to write reports where each assertion links to source documents in Corpus Review."

CONTEXT
"This is useful when preparing work product that must remain verifiable by others."

DEMONSTRATION
"We'll begin with a report already in progress."

[Show typing a new assertion in the report]

"A statement is added to the report."

[Show switching to Corpus tab, opening a source document, selecting relevant text]

"The supporting passage is located in the source document."

[Show right-click or menu option to copy a link to this location]

"A reference link is copied from this location."

[Show returning to the report, pasting the link after the assertion]

"The link is placed in the report adjacent to the assertion."

[Show clicking the link - it navigates back to the exact source page]

"Clicking the reference returns to the source page."

STRUCTURAL INSIGHT
"This structure ensures that each statement in the report remains connected to the underlying evidence."

SUMMARY
"This approach supports defensible work product while preserving direct access to source material."`,
    curation: `PROJECT: Thompson v. Northside Medical - Document Review

STARTING STATE: Complete Review

DOCUMENTS NEEDED:
• Expert_Analysis_DRAFT.crd - Report being written
• ED_Encounter_2024-03-11.pdf - Source document for assertion
• CT_Head_Report_2024-03-11.pdf - Additional source
• Nursing_Expert_Chronology_DRAFT.pdf - Shows existing linked structure
...
PRE-EXISTING HIGHLIGHTS:
• "Patient fell at home approximately 0630" (Blue)
• "Presentation to ED delayed until 1845" (Red)

PRE-EXISTING NOTES:
Note_001 (Timeline Gap Analysis) - shows existing linked note structure

ACTIONS ON CAMERA:
1. View existing report with linked assertions
2. Type new assertion: "The patient presented to the ED approximately twelve hours after the fall occurred."
3. Navigate to Corpus tab
4. Open ED_Encounter_2024-03-11.pdf
5. Locate and select the text about 0630 fall and 1845 presentation
6. Copy internal link (corpus-review://navigate... format)
7. Return to report
8. Paste link as reference
9. Click link to demonstrate navigation back to source

FINAL STATE:
Report contains new assertion with working source link`
  },
  "revisiting-work": {
    narration: `OPENING
"This short video shows how to return to a review project months later in Corpus Review."

CONTEXT
"This is useful when a case becomes active again after a period of dormancy."

DEMONSTRATION
"We'll begin at the project list."

[Show home screen with project list. The Thompson case shows "Last Used: 6 months ago."]

[Project opens to the Corpus tab, showing the document tree with categories and notes visible]

"The project opens with its previous organization intact."

[Click on a categorized document - categories and tags appear on the document]

"Categories and tags remain applied to documents."

[Navigate to Highlights tab, show the filtered list of highlights with dates]

"Highlights are preserved with their original timestamps."

[Open a note attached to a document, show internal links within the note]

"Notes remain attached to their source documents."

[Click an internal link within a note - it navigates to the exact source page]

"References within notes still navigate to their source locations."

STRUCTURAL INSIGHT
"This structure preserves the relationship between analysis and evidence regardless of elapsed time."

SUMMARY
"This approach supports continuity of review while maintaining the context established during prior work."`,
    curation: `PROJECT: Thompson v. Northside Medical - Document Review

STARTING STATE: Complete Review (presented as returning after 6 months)

PROJECT METADATA:
• "Last Used" timestamp from 6 months prior (visible on home screen)

DOCUMENTS NEEDED:
• ED_Encounter_2024-03-11.pdf - Show preserved categories/tags
• Note_001 (Timeline Gap Analysis) - Show preserved notes with links
• Office_Visit_2024-02-19.pdf - Target of internal link navigation

CATEGORIES TO SHOW (all):
• Standard of Care (Red)
• Key Timeline Event (Blue)
• Patient Communication (Green)
• Clinical Decision (Orange)
...
PRE-EXISTING HIGHLIGHTS (all from corpus-spec):
• "INR 3.1, supratherapeutic" (Yellow)
• "Warfarin reduced from 5mg to 4mg daily" (Blue)
• "Patient reports new bruising on forearms" (Pink)
• "Patient fell at home approximately 0630" (Blue)
• "Presentation to ED delayed until 1845" (Red)
• "Small acute intracerebral hemorrhage" (Red)

PRE-EXISTING NOTES:
• Note_001 (Timeline Gap Analysis) - with internal link
• Note_002 (Anticoagulation Management)

ACTIONS ON CAMERA:
1. View home screen with project list
2. Observe "Last Used: 6 months ago" on Thompson project
3. Click to open project
4. View document tree with categories visible
5. Click on categorized document to show applied categories/tags
6. Navigate to Highlights tab
7. Observe highlight list with timestamps
8. Navigate to Notes & Reports tab or expand note in tree
9. Open Note_001
10. Click internal link within note
11. Arrive at source page with relevant content visible

FINAL STATE:
No changes - video demonstrates that all prior work remains accessible`
  }
};
    ...
    videos: [
      {
        ...
        youtubeId: null,
        duration: "2:00",
        script: scripts["linked-assertions"],
      },
      {
        id: "revisiting-work",
        ...
        youtubeId: null,
        duration: "1:30",
        script: scripts["revisiting-work"],
      },
    ],
  },
];
